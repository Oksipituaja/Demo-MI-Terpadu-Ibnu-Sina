...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Prestasi>|Prestasi whereImage($value)
     ...
     * @property string|null $current_school
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereRegistrationNumber($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereStudentName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereBirthDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereBirthPlace($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereGender($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereReligion($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereCurrentSchool($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereGuardianName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereGuardianPhone($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereGuardianRelation($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration wherePhone($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereWave($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereNotes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration wherePaymentConfirmed($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration wherePaymentConfirmedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration wherePaymentProof($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereSource($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration whereDeletedAt($value)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<Registration>|Registration timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
