    ...
    public function run(): void
    {
        ...
        $news = [
            ...
            [
                ...
                'excerpt'      => 'MI Terpadu Ibnu Sina meluncurkan program literasi dini untuk meningkatkan kemampuan membaca dan menulis siswa kelas awal.',
                'content'      => '<p>Program literasi dini adalah inisiatif baru MI Terpadu Ibnu Sina untuk memastikan semua siswa memiliki keterampilan membaca yang kuat sejak usia dini.</p><p>Program ini melibatkan guru kelas, orang tua, dan komunitas lokal dalam mendukung perkembangan literasi anak-anak.</p><p>Setiap hari Jumat, siswa kelas 1 dan 2 akan mengikuti sesi membaca bersama selama 30 menit sebelum pelajaran dimulai.</p>',
                'status'       => 'published',
                'published_at' => Carbon::now()->subDays(7),
            ],
            [
                'title'        => 'Siswa MI Terpadu Ibnu Sina Raih Prestasi di Kompetisi Sains',
                'slug'         => 'siswa-MI-Terpadu-Ibnu-Sina-raih-prestasi-kompetisi-sains',
                'excerpt'      => 'Tiga siswa MI Terpadu Ibnu Sina berhasil meraih medali dalam Kompetisi Sains Tingkat Kabupaten yang diselenggarakan bulan ini.',
                'content'      => '<p>Kompetisi Sains Tingkat Kabupaten yang diikuti oleh lebih dari 50 sekolah berhasil dimenangkan oleh tiga siswa MI Terpadu Ibnu Sina.</p><p>Mereka berhasil meraih medali emas untuk kategori matematika, medali perak untuk IPA, dan medali perunggu untuk kategori lingkungan hidup.</p><p>Kepala sekolah menyampaikan rasa bangga dan berterima kasih kepada para guru pembimbing atas dedikasi mereka dalam mempersiapkan para siswa.</p>',
                'status'       => 'published',
            ...
            [
                ...
                'excerpt'      => 'Seluruh warga sekolah MI Terpadu Ibnu Sina menggelar kegiatan bakti sosial berupa pembagian sembako dan bersih-bersih lingkungan.',
                'content'      => '<p>Dalam rangka memperingati Hari Ulang Tahun Republik Indonesia ke-79, MI Terpadu Ibnu Sina menyelenggarakan kegiatan bakti sosial yang melibatkan seluruh siswa, guru, dan orang tua.</p><p>Kegiatan ini meliputi pembagian sembako kepada warga kurang mampu di sekitar sekolah serta aksi bersih-bersih lingkungan RT setempat.</p><p>Kegiatan ini bertujuan untuk menanamkan rasa kepedulian sosial dan rasa cinta tanah air sejak dini kepada para siswa.</p>',
                'status'       => 'published',
            ...
            [
                ...
                'excerpt'      => 'MI Terpadu Ibnu Sina akan segera memulai pembangunan gedung perpustakaan baru yang lebih modern dan nyaman untuk para siswa.',
                'content'      => '<p>Kabar baik untuk seluruh warga MI Terpadu Ibnu Sina! Pembangunan gedung perpustakaan baru yang lebih modern dan representatif akan segera dimulai bulan depan.</p><p>Perpustakaan baru ini dirancang dengan ruang baca yang lebih luas, koleksi buku yang lebih lengkap, serta area komputer untuk mendukung literasi digital siswa.</p><p>Dana pembangunan berasal dari program bantuan pemerintah daerah dan sumbangan sukarela dari komite sekolah dan orang tua siswa.</p>',
                'status'       => 'published',
