        ...
        <div class="flex items-center justify-between h-full max-w-screen-xl gap-4 px-6 mx-auto">
            ...
            <ul class="items-center hidden h-full gap-1 p-0 m-0 list-none lg:flex">
                <li class="flex items-center h-full">
                    <a href="{{ route('home') }}" class="flex items-center gap-1.5 px-3 py-1.5 text-[13.5px] font-semibold text-gray-600 hover:text-[#15803d] hover:bg-[#15803d]/[.07] rounded-lg transition-all">
                ...
                <li class="h-full has-dd">
                    ...
                    <div class="dd-menu">
                        <a href="{{ route('about') }}?section=sambutan" class="dd-item"><span class="dd-ic"><i class="fas fa-user-tie"></i></span> Sambutan Kepala Sekolah</a>
                        <a href="{{ route('about') }}?section=visi-misi&expanded=1" class="dd-item"><span class="dd-ic"><i class="fas fa-bullseye"></i></span> Visi & Misi</a>
                        <a href="{{ route('about') }}?section=tentang&expanded=1" class="dd-item"><span class="dd-ic"><i class="fas fa-info-circle"></i></span> Tentang Kami</a>
                        <a href="{{ route('teachers') }}" class="dd-item"><span class="dd-ic"><i class="fas fa-chalkboard-teacher"></i></span> Tenaga Pendidik</a>
                    </div>
                </li>
                ...
                <li class="h-full has-dd">
                    ...
                    <div class="dd-menu">
                        <a href="{{ route('mata-pelajaran') }}" class="dd-item"><span class="dd-ic"><i class="fas fa-book"></i></span> Mata Pelajaran</a>
                        <a href="{{ route('peraturan') }}" class="dd-item"><span class="dd-ic"><i class="fas fa-gavel"></i></span> Peraturan Sekolah</a>
                        <a href="{{ route('news') }}" class="dd-item"><span class="dd-ic"><i class="fas fa-newspaper"></i></span> Berita & Pengumuman</a>
                        <a href="{{ route('prestasi.index') }}" class="dd-item"><span class="dd-ic"><i class="fas fa-trophy"></i></span> Prestasi</a>
                        <a href="{{ route('facilities') }}" class="dd-item"><span class="dd-ic"><i class="fas fa-building"></i></span> Fasilitas</a>
                    </div>
                </li>
                ...
                <li class="h-full has-dd">
                    ...
                    <div class="dd-menu">
                        <a href="{{ route('news') }}?tab=agenda" class="dd-item"><span class="dd-ic"><i class="fas fa-calendar-check"></i></span> Agenda Kegiatan</a>
                        <a href="{{ route('gallery') }}" class="dd-item"><span class="dd-ic"><i class="fas fa-images"></i></span> Galeri</a>
                    </div>
                </li>
            </ul>
...
<div id="drawer">
    <div class="flex items-center justify-between px-5 py-4 border-b border-[#15803d]/10">
        <a href="{{ route('home') }}" class="flex items-center gap-2.5 no-underline">
            <img src="{{ asset('MI-Terpadu-Ibnu-Sina-Kembang-Jepara-Logo.png') }}" alt="Logo" class="object-contain w-8 h-8">
    ...
    <div class="p-3">
        ...
        <a href="{{ route('about') }}?section=sambutan" class="drw-link"><i class="fas fa-user-tie"></i> Sambutan Kepala Sekolah</a>
        <a href="{{ route('about') }}?section=visi-misi&expanded=1" class="drw-link"><i class="fas fa-bullseye"></i> Visi & Misi</a>
        <a href="{{ route('about') }}?section=tentang&expanded=1" class="drw-link"><i class="fas fa-info-circle"></i> Tentang Kami</a>
        <a href="{{ route('teachers') }}" class="drw-link"><i class="fas fa-chalkboard-teacher"></i> Tenaga Pendidik</a>
        ...
        <a href="{{ route('news') }}?tab=agenda" class="drw-link"><i class="fas fa-calendar-check"></i> Agenda Kegiatan</a>
        ...
        <div class="flex flex-col gap-3 pt-4 mt-3 border-t border-[#15803d]/10">
            <a href="{{ route('ppdb') }}" class="flex items-center justify-center gap-2 py-3 text-sm font-bold text-white rounded-xl" style="background:#15803d">
                <i class="fas fa-graduation-cap"></i> SPMB / PPDB
            </a>
            <a href="{{ route('home') }}#kontak" class="flex items-center justify-center gap-2 py-3 text-sm font-bold rounded-xl" style="background:#EAB308;color:#14532d">
...
<footer id="kontak" class="bg-[#0c2318] text-gray-400">
    <div class="max-w-screen-xl px-6 pb-10 mx-auto pt-14">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/[.05]">
            ...
            <div>
                ...
                <ul class="space-y-2.5 list-none p-0">
                    ...
                    <li>
                        <a href="{{ route($r) }}" class="flex items-center gap-2 text-sm text-gray-400 no-underline transition-colors hover:text-white">
                            <i class="fas fa-chevron-right text-[9px] text-[#15803d]/50"></i> {{ $l }}
                        </a>
                    </li>
                    @endforeach
                </ul>
                ...
                <div class="space-y-3.5 mb-4">
                    ...
                    <div class="flex items-start gap-2.5">
                        ...
                        <div>
                            ...
                            <a href="{{ $href }}" class="text-sm font-semibold text-gray-300 no-underline transition-colors hover:text-white">{!! $val !!}</a>
                        </div>
                    </div>
                    @endforeach
                    <div class="flex items-start gap-2.5">
            ...
            <div>
                ...
                <div class="flex items-center justify-between py-2.5 border-b border-white/[.04]">
                    ...
                    <span class="text-xs font-bold px-2.5 py-1 rounded-full {{ $off ? 'bg-red-900/20 text-red-400' : 'text-[#4ade80]' }}" style="{{ $off ? '' : 'background:rgba(21,128,61,.17)' }}">{{ $t }}</span>
                </div>
                @endforeach
                <div class="p-4 mt-5 border rounded-xl" style="background:rgba(234,179,8,.05);border-color:rgba(234,179,8,.13)">
                    ...
                    <a href="{{ route('ppdb') }}" class="text-xs font-bold text-[#EAB308] hover:text-yellow-300 inline-flex items-center gap-1 no-underline transition-colors">
        ...
        <div class="flex flex-col items-center justify-between gap-3 md:flex-row pt-7">
            <p class="text-xs text-gray-600">© {{ date('Y') }} <span class="font-semibold text-gray-500">{{ config('app.name') }}</span>. Semua hak dilindungi.</p>
            <div class="flex items-center gap-1 text-xs">
                <a href="{{ route('privacy') }}" class="px-2.5 py-1 text-gray-500 hover:text-gray-300 rounded-lg transition-colors no-underline">Kebijakan Privasi</a>
                <span class="text-gray-700">·</span>
                <a href="{{ route('terms') }}" class="px-2.5 py-1 text-gray-500 hover:text-gray-300 rounded-lg transition-colors no-underline">Syarat & Ketentuan</a>
            </div>
        </div>
    </div>
</footer>
