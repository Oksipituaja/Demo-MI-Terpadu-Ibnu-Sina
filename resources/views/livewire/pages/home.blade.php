<div>
                        ...
                        <div class="relative group">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <p class="text-blue-200 text-sm italic">Kepala Sekolah {{ config('app.name') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="text-center mt-12">
                <a href="{{ route('teachers') }}"
                    class="inline-flex items-center px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    Lihat Semua Guru
    ...
    <div class="py-20 bg-linear-to-b from-white to-blue-50">
        <div class="container mx-auto px-6">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <h2 class="font-display text-4xl font-bold text-gray-900 mt-4 mb-6">Prestasi Terbaru {{ config('app.name') }}</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                ...
                @else
                    @foreach ($prestasis as $prestasi)
                        ...
                        @endphp
                        <div
                            class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group border border-gray-200 h-full flex flex-col">
                            <div
                                class="bg-linear-to-br from-gray-50 to-gray-100 px-6 py-8 flex items-center justify-center shrink-0">
                                <div
                            ...
                            <div class="p-6 flex flex-col flex-1">
                                <h3 class="text-lg font-bold text-gray-900 mb-2 leading-snug line-clamp-2">
                                    {{ $prestasi->title }}</h3>
            ...
            @if ($prestasis->isNotEmpty())
                <div class="text-center">
                    <a href="{{ route('prestasi.index') }}"
                        class="inline-block px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl">
    ...
    <section class="pt-4 pb-12 bg-white border-t border-gray-100">
        <div class="container mx-auto px-6">
            <div class="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 bg-blue-50 rounded-2xl px-8 py-6">
                <div>
                    <p class="font-bold text-gray-900 text-lg leading-tight">Pendaftaran PPDB 2026/2027 Masih Dibuka</p>
                    <p class="text-gray-500 text-sm mt-1">Segera daftarkan putra-putri Anda sebelum kuota penuh.</p>
                </div>
                <a href="{{ route('ppdb') }}"
