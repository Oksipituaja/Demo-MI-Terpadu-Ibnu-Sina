    ...
    <section class="relative overflow-hidden bg-[#F0F4ED]">
        ...
        <div class="relative z-10 max-w-screen-xl px-6 py-14 mx-auto lg:py-20">
            <div class="max-w-2xl">
                ...
                <h1 class="text-[2rem] sm:text-[2.4rem] lg:text-[2.8rem] font-extrabold leading-[1.18] tracking-tight text-gray-900 mb-4">
                    Ada Pertanyaan<br>
                    <span style="background:linear-gradient(90deg,#15803d,#22c55e);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">
                        Seputar Sekolah?
                    </span>
                </h1>
                <p class="text-[15px] leading-relaxed text-gray-500">
                    ...
                    {{ config('app.name') }}. Tim kami akan menjawab langsung ke email Anda dalam 1–2 hari kerja.
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16">
                ...
                <div class="flex flex-col gap-8 lg:col-span-5">
                    ...
                    <div class="flex flex-col gap-3">
                        @foreach ([
                            ['fas fa-bolt',             'Respons Cepat',    'Jawaban dikirim dalam 1–2 hari kerja'],
                            ['fas fa-envelope-open-text','Langsung ke Email','Jawaban dikirim langsung ke inbox Anda'],
                            ['fas fa-shield-alt',        'Privasi Terjaga',  'Data Anda aman dan tidak akan disebarkan'],
                        ] as [$icon, $title, $desc])
                            <div class="flex items-start gap-4 p-4 rounded-2xl bg-[#f8fdf9] border border-[#15803d]/10">
                                ...
                                <div>
                                    ...
                                    <p class="text-[13px] text-gray-400 mt-0.5 leading-relaxed">{{ $desc }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-col gap-3">
                            <a href="https://wa.me/6281234567890" target="_blank" rel="noopener"
                                ...
                                <i class="fas fa-arrow-right text-[#15803d] text-xs ml-auto opacity-0 group-hover:opacity-100 transition-opacity"></i>
                            </a>
                            <a href="mailto:info@miterpaduibnusina.sch.id"
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-sm font-extrabold text-[#14532d] truncate">info@miterpaduibnusina.sch.id</p>
                                </div>
                                <i class="fas fa-arrow-right text-[#15803d] text-xs ml-auto opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 p-4 rounded-2xl border border-[#15803d]/10"
                        ...
                        <div>
                            ...
                            <p class="text-sm font-extrabold text-[#14532d]">Terakreditasi B — Kemenag RI</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="relative bg-white rounded-[22px] border border-[#15803d]/10 overflow-hidden"
                            ...
                            <div class="px-7 py-5 border-b border-[#e8f5e9]"
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-white font-extrabold text-[15px] leading-none">Formulir Konsultasi</p>
                            ...
                            @if (session()->has('sent'))
                                <div class="px-7 py-10 text-center">
                                    <div class="flex items-center justify-center w-16 h-16 rounded-full mx-auto mb-5"
                                        ...
                                        <svg width="28" height="28" fill="none" stroke="#15803d" stroke-width="2.5" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/>
                                        </svg>
                                    </div>
                                    ...
                                    <div class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold text-[#15803d] bg-[#15803d]/[.08] border border-[#15803d]/15">
                                        <i class="fas fa-clock text-xs"></i>
                                        Estimasi balasan: 1–2 hari kerja
                                    </div>
                                </div>
                            ...
                            @else
                                <form wire:submit.prevent="submit" class="px-7 py-7 space-y-5">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div>
                                            <label class="block text-[11px] font-extrabold uppercase tracking-[.12em] text-gray-400 mb-2">
                                    ...
                                    <div>
                                        <label class="block text-[11px] font-extrabold uppercase tracking-[.12em] text-gray-400 mb-2">
                                            Topik Pertanyaan
                                            <span class="normal-case tracking-normal font-normal text-gray-400/70 ml-1">(opsional)</span>
                                        </label>
                                    ...
                                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-1">
                                        <p class="text-[11.5px] text-gray-400 flex items-center gap-1.5 order-2 sm:order-1">
                        ...
                        @if (!session()->has('sent'))
                            <div class="absolute -bottom-5 -left-4 z-10 hidden lg:flex items-center gap-2.5 px-4 py-3 rounded-2xl bg-white"
                                ...
                                <div>
                                    <p class="text-[8px] uppercase tracking-widest text-gray-400 font-bold leading-none mb-0.5">Dijawab Tim</p>
                                    <p class="text-[13px] font-extrabold text-gray-900 leading-none">Langsung ke Email</p>
                                </div>
                            </div>
                        @endif
    ...
    <section class="py-16 bg-[#F0F4ED] border-t border-[#e8f5e9]">
        <div class="max-w-screen-xl px-6 mx-auto">
            <div class="max-w-xl mx-auto text-center mb-10">
                ...
                <h2 class="mt-3 text-[1.7rem] font-extrabold text-[#14532d] tracking-tight">Pertanyaan yang Sering Ditanyakan</h2>
            </div>
            <div class="max-w-3xl mx-auto grid grid-cols-1 gap-3">
                @foreach ([
                    ['Kapan pendaftaran siswa baru dibuka?',         'Pendaftaran peserta didik baru (PPDB/SPMB) dibuka setiap awal tahun ajaran. Pantau terus halaman SPMB kami untuk informasi terbaru.'],
                    ['Apa saja syarat pendaftaran?',                  'Syarat umum meliputi: akta kelahiran, kartu keluarga, dan foto terbaru. Detail lengkap tersedia di halaman SPMB.'],
                    ['Apakah ada biaya konsultasi?',                  'Tidak ada. Layanan konsultasi ini sepenuhnya gratis untuk semua calon wali murid dan masyarakat umum.'],
                    ['Berapa lama waktu balasan?',                    'Kami berusaha menjawab setiap pertanyaan dalam 1–2 hari kerja langsung ke email Anda.'],
                ] as [$q, $a])
                    <div x-data="{ open: false }"
                        ...
                        <button @click="open = !open"
                            ...
                            <span class="flex-shrink-0 flex items-center justify-center w-7 h-7 rounded-full transition-all"
                        ...
                        <div x-show="open" x-collapse class="px-6 pb-5">
                            <p class="text-[13.5px] text-gray-500 leading-relaxed border-t border-[#e8f5e9] pt-4">{{ $a }}</p>
                        </div>
                    </div>
                @endforeach
            </div>
