<div class="min-h-screen" style="background: #F0F4ED">
    <div class="px-4 py-12 text-white" style="background: linear-gradient(to right, #15803d, #166534)">
        <div class="max-w-4xl mx-auto">
            <a href="/news" class="inline-block mb-4 transition-colors hover:text-white" style="color: #86efac">← Kembali ke Berita</a>
    ...
    <div class="max-w-4xl px-4 py-16 mx-auto">
        <div class="mb-6">
            <p class="text-sm text-gray-500">Dipublikasikan pada {{ \Carbon\Carbon::parse($news->published_at)->format('d M Y H:i') }}</p>
        </div>
        ...
        <div class="pt-8 mt-12 border-t" style="border-color: #15803d26">
            <a href="/news" class="font-semibold transition-colors hover:opacity-80" style="color: #15803d">
                ← Kembali ke Berita
            </a>
        </div>
    </div>
