...
<div class="max-w-2xl mx-auto bg-white rounded-lg shadow p-6">
    <form action="{{ route('admin.galleries.update', $gallery) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="title" id="galleryTitle" value="{{ old('title', $gallery->title) }}" required
        ...
        <div>
            ...
            <div class="flex gap-2">
                <input type="text" name="slug" id="gallerySlug" value="{{ old('slug', $gallery->slug) }}" required
        ...
        <div>
            ...
            <textarea name="description" rows="3"
                class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('description', $gallery->description) }}</textarea>
        </div>
