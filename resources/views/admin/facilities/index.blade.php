            ...
            <tbody class="divide-y divide-gray-200">
                @forelse($facilities as $facility)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            @php
                                $kondisiMap = [
                                    ...
                                    'perbaikan' => ['label' => 'Perbaikan', 'class' => 'bg-yellow-100 text-yellow-700'],
                                    'belum_ada' => ['label' => 'Belum Ada', 'class' => 'bg-red-100 text-red-700'],
                                    'akan_ada'  => ['label' => 'Akan Ada',  'class' => 'bg-blue-100 text-blue-700'],
                                ];
                                $k = $kondisiMap[$facility->kondisi] ?? ['label' => '—', 'class' => 'bg-gray-100 text-gray-600'];
                            @endphp
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600">
                            {{ Str::limit($facility->description, 60) ?: '—' }}
                        </td>
                        <td class="px-6 py-4">
