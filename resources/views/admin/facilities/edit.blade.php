        ...
        <form action="{{ route('admin.facilities.update', $facility) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('description', $facility->description) }}</textarea>
            </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                window.updateIconPreview = function() {
                    ...
                    document.getElementById('iconPreviewEl').className =
                        (val || 'fas fa-question') + ' text-blue-600 text-lg';
                };
