    ...
    <form action="{{ route('admin.facilities.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
        ...
        <div>
            ...
            <select name="kondisi" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" required>
                ...
                <option value="perbaikan" {{ old('kondisi') === 'perbaikan' ? 'selected' : '' }}>Sedang Perbaikan</option>
        ...
        <div class="flex gap-3 pt-4 border-t">
            @include('components.admin-submit-btn', ['label' => 'Simpan Fasilitas', 'loading' => 'Menyimpan...'])
