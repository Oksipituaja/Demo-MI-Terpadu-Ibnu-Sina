                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                @else
                                    <div class="flex items-center justify-center w-10 h-10 bg-gray-100 rounded-lg shrink-0">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600">
                            <div class="flex items-center gap-2">
                                <div class="flex items-center justify-center w-6 h-6 text-xs font-semibold text-white bg-blue-500 rounded-full">
