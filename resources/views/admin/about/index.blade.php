                ...
                @forelse($abouts as $about)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            @php
                                $keyMap = [
                                    'hero_image'         => ['label' => 'Gambar Utama',        'class' => 'bg-indigo-100 text-indigo-700'],
                                    'principal_greeting' => ['label' => 'Sambutan Kepsek',      'class' => 'bg-green-100 text-green-700'],
                                    'school_profile'     => ['label' => 'Profil Sekolah',       'class' => 'bg-blue-100 text-blue-700'],
                                    'school_info'        => ['label' => 'Informasi Sekolah',    'class' => 'bg-yellow-100 text-yellow-700'],
                                    'vision'             => ['label' => 'Visi',                 'class' => 'bg-purple-100 text-purple-700'],
                                    'mission'            => ['label' => 'Misi',                 'class' => 'bg-pink-100 text-pink-700'],
                                ];
                                $k = $keyMap[$about->key] ?? ['label' => $about->key, 'class' => 'bg-gray-100 text-gray-600'];
                            @endphp
