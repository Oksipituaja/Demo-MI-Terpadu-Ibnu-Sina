        ...
        <form action="{{ route('admin.about.update', $about) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <select id="keySelect" name="key" disabled
                    ...
                    <option value="hero_image" {{ $about->key === 'hero_image' ? 'selected' : '' }}>Gambar Utama
                        (Homepage)</option>
            ...
            {{-- Wrapper konten: tampil untuk semua key kecuali school_info --}}
            <div id="contentWrapper" class="{{ $about->key === 'school_info' ? 'hidden' : '' }}">
                ...
                {{-- Skeleton TinyMCE: hanya render jika bukan school_info --}}
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (currentKey === 'school_info') {
                    // Tidak perlu TinyMCE, pasang listener JSON builder saja
