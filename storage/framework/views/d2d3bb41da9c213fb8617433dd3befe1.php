            ...
            <div class="grid items-center gap-12 lg:grid-cols-2">
                <div class="space-y-6 animate-fade-in">
                    ...
                    <p class="text-lg leading-relaxed text-gray-600">
                        <?php echo e(config('app.name')); ?> berkomitmen memberikan pendidikan berkualitas dengan fasilitas modern
                    ...
                    <div class="relative w-full max-w-lg">
                        <div
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($heroImage && $heroImage->image): ?>
                                <img src="<?php echo e(asset('files/' . $heroImage->image)); ?>" alt="<?php echo e(config('app.name')); ?>"
                                ...
                                <div class="relative w-72 h-96 md:w-80 md:h-112.5 rounded-4xl overflow-hidden shadow-2xl border-8"
                                    ...
                                    <div class="absolute inset-x-0 bottom-0 p-6 pt-12"
                                        ...
                                        <p class="mb-0 text-xl font-bold text-white">
                                            <?php echo e($principalGreeting?->principal_name ?? 'Kepala Sekolah'); ?></p>
                    ...
                    <div class="text-center teacher-card">
                        <div class="flex items-center justify-center w-32 h-32 mx-auto mb-4 overflow-hidden transition-transform duration-300 rounded-full hover:scale-105"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($teacher->image): ?>
                                <img src="<?php echo e(asset('files/' . $teacher->image)); ?>" alt="<?php echo e($teacher->name); ?>"
                                    class="object-cover w-full h-full">
                            <?php else: ?>
                        ...
                        <h3 class="text-xl font-bold font-display" style="color: #14532d">
                            <?php echo e($teacher->name ?? 'Guru'); ?></h3>
                        <p class="mb-2 font-semibold" style="color: #15803d"><?php echo e($teacher->subject ?? 'Pendidik'); ?>
    ...
    <section id="berita" class="py-20 border-t" style="background: #F0F4ED; border-color: #d1fae5">
        <div class="container px-6 mx-auto">
            <div class="flex flex-col items-center justify-between gap-8 mb-12 md:flex-row">
                ...
                <a href="<?php echo e(route('news')); ?>?tab=agenda" class="flex items-center font-semibold transition-colors"
                    style="color: #15803d">
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-center px-6 py-8 shrink-0"
                                ...
                                <div class="flex items-center justify-center w-24 h-24 transition-transform duration-300 transform rounded-full shadow-lg group-hover:scale-110"
                                    style="<?php echo e($award['bgStyle']); ?>">
                                    <i class="<?php echo e($award['icon']); ?> text-white text-5xl"></i>
                                </div>
                            </div>

                            <div class="flex flex-col flex-1 p-6">
                                <h3 class="mb-2 text-lg font-bold leading-snug text-gray-900 line-clamp-2">
                                    <?php echo e($prestasi->title); ?></h3>
                                ...
                                <p class="flex-1 mb-3 text-sm leading-relaxed text-gray-600 line-clamp-2">
                                    <?php echo e($prestasi->description); ?></p>
...
<?php /**PATH C:\laragon\www\4329_Yusuf_Hammam\resources\views/livewire/pages/home.blade.php ENDPATH**/ ?>