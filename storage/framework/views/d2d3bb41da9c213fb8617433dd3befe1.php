        ...
        <div class="grid items-center grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-14">
            ...
            <div class="flex flex-col order-1 gap-5 lg:gap-6 lg:order-1">
                ...
                <div class="inline-flex items-center gap-2 w-fit px-3.5 py-1.5 rounded-full bg-white border border-[#15803d]/15"
                    ...
                    <span class="text-[11.5px] font-semibold text-[#15803d] tracking-wide">Terakreditasi B &nbsp;·&nbsp; Resmi Kemenag</span>
                </div>
                ...
                <p class="text-[14.5px] lg:text-[15px] leading-relaxed text-gray-500">
                    <?php echo e(config('app.name')); ?> berkomitmen memberikan pendidikan berkualitas
                ...
                <div class="grid grid-cols-3 gap-2.5 sm:flex sm:items-stretch sm:gap-3 pt-1">
                    ...
                    <div class="flex flex-col items-center text-center px-2 sm:px-5 py-3.5 rounded-2xl bg-white border border-[#15803d]/10"
                        ...
                        <span class="text-xl sm:text-[1.55rem] font-extrabold text-[#15803d] leading-none tracking-tight"><?php echo e($num); ?></span>
                        <span class="text-[10px] sm:text-[11px] text-gray-400 font-medium mt-1.5 leading-snug"><?php echo e($label); ?></span>
                    </div>
            ...
            <div class="order-2 lg:order-2">
                ...
                <div class="relative px-4 pt-1 pb-6 sm:px-5 lg:px-0 lg:pt-0 lg:pb-5">
                    ...
                    <div class="hero-img-wrap relative rounded-[18px] sm:rounded-[22px] overflow-hidden w-full"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($heroImage && $heroImage->image): ?>
                            <img src="<?php echo e(asset('files/' . $heroImage->image)); ?>"
                                alt="<?php echo e(config('app.name')); ?>"
                                class="w-full h-full object-cover transition-transform duration-700 hover:scale-[1.03]">
                        <?php else: ?>
                            <img src="<?php echo e(asset('hero_image.png')); ?>"
                                alt="<?php echo e(config('app.name')); ?>"
                                class="w-full h-full object-cover transition-transform duration-700 hover:scale-[1.03]">
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($principalGreeting?->title): ?>
            ...
            <div class="flex justify-center lg:col-span-5">
                <div class="relative">
                    ...
                    <div class="relative w-56 h-72 md:w-64 md:h-80 rounded-[22px] overflow-hidden border-4 border-white bg-[#dcfce7]"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($principalGreeting?->image): ?>
                            <img src="<?php echo e(asset('files/' . $principalGreeting->image)); ?>"
                                alt="<?php echo e($principalGreeting->principal_name ?? 'Kepala Sekolah'); ?>"
                        ...
                        <div class="absolute inset-x-0 bottom-0 px-5 pt-10 pb-4"
                            ...
                            <p class="text-white font-extrabold text-[15px] leading-tight">
                                <?php echo e($principalGreeting?->principal_name ?? 'Kepala Sekolah'); ?>

                            </p>
                            <p class="text-xs text-[#86efac] italic mt-1">
                                Kepala Sekolah <?php echo e(config('app.name')); ?>
            ...
            <div class="flex flex-col gap-6 lg:col-span-7">
                <div>
                    ...
                    <h2 class="text-[1.9rem] lg:text-[2.1rem] font-extrabold text-gray-900 leading-snug tracking-tight">
                        <?php echo e($principalGreeting?->title); ?>
                ...
                <div class="p-5 rounded-2xl bg-[#f8fdf9] border border-[#15803d]/10 border-l-4 border-l-[#15803d]">
                    <p class="text-[15px] leading-[1.85] text-gray-600 italic">
                        "<?php echo Str::limit(strip_tags($principalGreeting?->content ?? ''), 450); ?>"
                    </p>
                </div>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="flex flex-col items-center text-center px-8 py-9 rounded-2xl bg-white border border-[#15803d]/10 transition-all hover:-translate-y-1"
                ...
                <div class="w-[88px] h-[88px] rounded-full overflow-hidden mb-5 flex-shrink-0"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($teacher->image): ?>
                        <img src="<?php echo e(asset('files/' . $teacher->image)); ?>" alt="<?php echo e($teacher->name); ?>" class="object-cover w-full h-full">
                    <?php else: ?>
                ...
                <h3 class="text-[15px] font-extrabold text-[#14532d]"><?php echo e($teacher->name ?? 'Guru'); ?></h3>
                <p class="text-xs font-semibold text-[#15803d] mt-1.5"><?php echo e($teacher->subject ?? 'Pendidik'); ?></p>
            </div>
...
<section id="berita" class="py-20 bg-white border-t border-[#e8f5e9]">
    <div class="max-w-screen-xl px-6 mx-auto">
        <div class="flex flex-col justify-between gap-4 mb-12 sm:flex-row sm:items-end">
            ...
            <a href="<?php echo e(route('news')); ?>?tab=agenda"
            ...
            <article class="flex flex-col h-full overflow-hidden transition-all bg-white border border-gray-100 rounded-2xl hover:-translate-y-1 hover:shadow-lg"
                ...
                <div class="h-[200px] overflow-hidden flex-shrink-0 bg-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($news->featured_image): ?>
                        <img src="<?php echo e(asset('files/' . $news->featured_image)); ?>" alt="<?php echo e($news->title); ?>"
                    ...
                    <?php else: ?>
                        <div class="flex items-center justify-center w-full h-full text-5xl font-black text-white/25"
                            ...
                            <?php echo e(strtoupper(substr($news->title,0,1))); ?>
                ...
                <div class="flex flex-col flex-1 p-5">
                    <span class="text-[10.5px] font-bold text-[#15803d] bg-[#15803d]/[.08] px-2.5 py-1 rounded-md w-fit mb-3">
                        <?php echo e($news->published_at?->format('d M Y') ?? 'Terbaru'); ?>

                    </span>
                    <h3 class="text-[15px] font-bold text-gray-900 leading-snug mb-2.5 line-clamp-2"><?php echo e($news->title); ?></h3>
                    ...
                    <div class="pt-4 border-t border-gray-100">
                        <a href="<?php echo e(route('news.detail', $news->slug)); ?>"
    ...
    <div class="max-w-screen-xl px-6 mx-auto">
        <div class="max-w-xl mx-auto text-center mb-14">
            ...
            <h2 class="mt-3 text-[2rem] lg:text-[2.2rem] font-extrabold text-[#14532d] tracking-tight">
                Prestasi Terbaru <?php echo e(config('app.name')); ?>

            </h2>
        </div>

        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prestasis->isEmpty()): ?>
            <div class="py-10 text-center text-gray-400 col-span-full">Belum ada prestasi yang dipublikasikan</div>
            <?php else: ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $prestasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prestasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $award = getAwardIcon($prestasi->category); ?>
                    <div class="flex flex-col h-full overflow-hidden transition-all bg-white border border-gray-100 rounded-2xl hover:-translate-y-1 hover:shadow-lg"
                        ...
                        <div class="flex items-center justify-center flex-shrink-0 px-6 py-8 bg-gray-50">
                            <div class="w-[72px] h-[72px] rounded-2xl flex items-center justify-center transition-transform hover:scale-110"
                                style="<?php echo e($award['bgStyle']); ?>;box-shadow:0 6px 18px rgba(0,0,0,.11)">
                                <i class="<?php echo e($award['icon']); ?> text-white text-3xl"></i>
                            </div>
                        </div>
                        <div class="flex flex-col flex-1 p-5">
                            <h3 class="text-[15px] font-bold text-gray-900 leading-snug mb-1.5 line-clamp-2"><?php echo e($prestasi->title); ?></h3>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prestasi->category): ?>
                            <div class="text-[10.5px] font-extrabold uppercase tracking-wide mb-2" style="<?php echo e($award['textStyle']); ?>">
                                <?php echo e($prestasi->category); ?>

                            </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <p class="text-[13.5px] text-gray-400 leading-relaxed flex-1 mb-3 line-clamp-2"><?php echo e($prestasi->description); ?></p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prestasi->achievement_date): ?>
                            <div class="flex items-center gap-1.5 text-xs text-gray-400 mb-4">
                                <i class="fas fa-calendar-alt text-[10px]"></i>
                                <?php echo e($prestasi->achievement_date->format('d M Y')); ?>

                            </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <div class="pt-4 mt-auto border-t border-gray-100">
                                <a href="<?php echo e(route('prestasi.detail', $prestasi->slug)); ?>"
                                    class="inline-flex items-center gap-1.5 text-[13px] font-bold transition-all hover:gap-3"
                                    style="<?php echo e($award['textStyle']); ?>">
                                    Baca Selengkapnya <i class="text-xs fas fa-arrow-right"></i>
                                </a>
                            </div>
                        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($prestasis->isNotEmpty()): ?>
        <div class="mt-10 text-center">
...
</div><?php /**PATH C:\laragon\www\4329_Yusuf_Hammam\resources\views/livewire/pages/home.blade.php ENDPATH**/ ?>