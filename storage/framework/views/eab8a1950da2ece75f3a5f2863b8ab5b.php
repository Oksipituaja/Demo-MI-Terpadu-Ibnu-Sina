    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @keyframes pulse {
            ...
            50% { filter: drop-shadow(0 0 32px rgba(220,38,38,0.7)); }
        }
        ...
        /* ── Info box ── */
        .info-box {
            display: flex; gap: 0.75rem; text-align: left;
...
<div class="wrapper">
    ...
    <div class="error-icon-wrap">
        ...
        <svg class="main-icon" viewBox="0 0 80 88" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M40 4L8 16V44C8 61.6 22.4 78 40 84C57.6 78 72 61.6 72 44V16L40 4Z"
                fill="rgba(220,38,38,0.1)" stroke="#dc2626" stroke-width="2"/>
            ...
            <path d="M33 42V37C33 33.7 36.7 31 40 31C43.3 31 47 33.7 47 37V42"
                stroke="#dc2626" stroke-width="2.5" stroke-linecap="round" fill="none"/>
    ...
    <div class="card">
        ...
        <p class="error-desc">Anda tidak memiliki izin untuk mengakses halaman ini. Hubungi Super Admin jika Anda merasa ini adalah kesalahan.</p>
        ...
        <div class="info-box">
            <svg class="info-box-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div>
                ...
                <p class="info-box-text">
                    ...
                    <?php else: ?>
                        Anda tidak memiliki izin yang cukup untuk mengakses halaman ini. Hubungi Super Admin untuk mendapatkan akses.
...
</html><?php /**PATH C:\laragon\www\4329_Yusuf_Hammam\resources\views/errors/403.blade.php ENDPATH**/ ?>